...
const useAsideTouch = () => {
	...
	const x = useMotionValue(import.meta.env.VITE_ASIDE_TOUCH_STATUS === "true" ? 0 : asideWidthWithSpace)
	const [touchStatus, setTouchStatus] = useState(!x.get())
	const left = useTransform(x, [-100, -90, -10, 0], [asideWidthWithSpace, asideWidthWithSpace, 0, 0])
