...
export const hasNotch = () => {
	...
	return (iPhone && aspect.toFixed(3) === "0.462") || (storybook && aspectFrame.toFixed(3) === "0.462")
}
...
export const percent = (value1: number, value2: number) => Number(((value1 / value2 - 1) * 100).toFixed(2))
